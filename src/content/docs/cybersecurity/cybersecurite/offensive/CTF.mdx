---
title: Les Capture The Flag
description: Les CTF sont des mises à disposition d’éléments vulnérables tels que des applications, des réseaux, des systèmes d’exploitation et bien d’autres, avec pour objectif de prendre le contrôle maximal de ceux-ci et de récupérer des « flags ». Ces flags sont des preuves que l’on a bien réussi à exploiter les vulnérabilités._
