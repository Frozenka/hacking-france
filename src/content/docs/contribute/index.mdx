...
import ReadingTime from '../../../components/starlight/ReadingTime.astro';
...
## Où mettre mon contenu ? :badge[Important]{variant=tip}
...
##  À lire avant de contribuer :badge[MANDATORY]{variant=danger}
...
- Utilisez le composant `Image` d'Astro pour insérer des images, en spécifiant le **chemin**, le **alt**, le **format** et la **qualité** [Comment faire ?](#images)
- Pour le chemin des images, suivez la **convention d'arborescence du repo**. [Voir ici.](#images)
- **Testez votre article localement avant de soumettre la PR pour vérifier le rendu**, **le projet ne doit pas retourner d'erreurs**. [Comment faire ?](#tester-le-project-localement)
...
- [Code de conduite](https://github.com/Frozenka/hacking-france/blob/main/CODE_OF_CONDUCT.md)
- [Licence](https://github.com/Frozenka/hacking-france/blob/main/LICENSE)

## Tester le project localement :badge[MANDATORY]{variant=danger} 
...
## Formatage des articles :badge[MANDATORY]{variant=danger} :badge[Important]{variant=tip}
...
Pour la modification des pages [YouTube](/misc/youtube/) [Twitch](/misc/twitch/) et [Discord](/misc/discord/), rien de plus simple :  
il vous suffit d'éditer les fichiers texte correspondants : 
`src/assets/misc/liste_youtube.txt ou liste_twitch.txt ou liste_discord.txt`
