...
Pour éviter de sombrer dans la gestion de projet, il m'arrive de faire des streams sur des boxs VulnLab, HackTheBox (un peu de dev) les soirs.
...
J'aime également l'OSINT et le lockpicking. Et quand les journées feront + de 24h je me mettrai à l'analyse et au dev de malware.
