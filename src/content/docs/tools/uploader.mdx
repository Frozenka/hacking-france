...
Il génère automatiquement la commande de téléchargement appropriée en fonction de la demande (Curl, Wget, Certutil, PowerShell, etc.) et ouvre un serveur Python local pour fournir le fichier à télécharger jusqu'à ce qu'une réponse HTTP 200 soit reçue,  
...
Utilisez la commande suivante pour installer Uploader :

```bash wrap frame="terminal" title="Installation"
